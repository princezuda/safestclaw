"""
SafestClaw Coding Action - Code generation and assistance.
...
class CodeAction(BaseAction):
    ...
    async def _get_ai_writer(self, engine: "SafestClaw"):
    ...
    async def _llm_generate(self, description: str, user_id: str, engine: "SafestClaw") -> str:
    ...
    async def _llm_explain(self, path_str: str, user_id: str, engine: "SafestClaw") -> str:
    ...
    async def _llm_review(self, path_str: str, user_id: str, engine: "SafestClaw") -> str:
    ...
    async def _llm_refactor(self, path_str: str, user_id: str, engine: "SafestClaw") -> str:
    ...
    async def _llm_document(self, path_str: str, user_id: str, engine: "SafestClaw") -> str:
