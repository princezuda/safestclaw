"""
SafestClaw Command Parser - Rule-based intent classification.
...
from safestclaw.core.i18n import (
    LANGUAGE_PACK,
    get_language_name,
        ...
        default_intents = [
            ...
            IntentPattern(
                ...
                examples=[
                    ...
                    "calendar import ~/calendar.ics",
                    "calendar sync",
                ],
                slots=["subcommand", "argument"],
            ),
            IntentPattern(
                intent="shell",
            ...
            IntentPattern(
                ...
                patterns=[
                    ...
                    r"(?:show\s+)?diagram",
                    r"how\s+does\s+(?:it|this|safestclaw)\s+work",
                ],
                examples=[
                    "flow",
                    "show system flow",
