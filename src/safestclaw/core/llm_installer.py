"""
SafestClaw LLM Setup - Super simple AI configuration.
...
async def setup_local(
    ...
    """
    Auto-setup local AI: install Ollama + pull model + configure SafestClaw.
...
def setup_telegram(token: str, config_path: Path) -> str:
    ...
    if not token:
        return (
            ...
            "2. Send: /newbot\n"
            "3. Choose a name (e.g. My SafestClaw) and username (must end in 'bot')\n"
            "4. Copy the token BotFather gives you\n"
            "5. Run:\n"
            "   setup telegram <your-token>\n\n"
            "Then restart SafestClaw — your bot will be live."
        )
